...
//
//        String realmId = (String)session.getAttribute("realmId1");
//        if (StringUtils.isEmpty(realmId1)) {
//            return new JSONObject().put("response","No realm ID.  QBO calls only work if the accounting scope was passed!").toString();
//        }
//        String accessToken = (String)session.getAttribute("access_token1");
...
//
//            //get DataService
//            DataService service = helper.getDataService(realmId1, accessToken1);
//
//            // get all companyinfo
//            System.out.println("line 333");
